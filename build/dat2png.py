...
#        convert_image('amplitude' + str(i))
        ...
        convert_image('amp_depth_' + str(i), fixed_range=True, max_value=1600)
        convert_image('phase_depth_' + str(i), auto_range=True)
    convert_image('accumurate_depth', auto_range=True, max_rate=99)
    # convert_image('depth_raw', auto_range=True)
    convert_image('depth_bins', auto_range=True, print_minmax=True)
